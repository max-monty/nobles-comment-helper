      ...
      <div className="w-full max-w-sm">
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 text-center">
          ...
          {configError ? (
            ...
            <>
              {domainError && (
                <div className="bg-amber-50 border border-amber-200 rounded-lg px-4 py-4 text-left mb-5">
              ...
              <button
                ...
                disabled={signingIn}
                className={`w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer ${
                  domainError
